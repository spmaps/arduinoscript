...
{ 
   ...
   else if ((!isWorkingHours) && (basementTooCold))
   {
   ...
   else if ((basementTooCold) && (isWorkingHours) && (isSomeoneHome))
   {
     digitalWrite(Relay, HIGH);
   }
    else if ((isWorkingHours) && (!isSomeoneHome))
   {
     digitalWrite(Relay, LOW);
   }
}
...
void updateTemperatures()
{
  ...
  //Check to see if basement (temp2) too hot      
  ...
  //Check to see if basement (temp2) too cold   
