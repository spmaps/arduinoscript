...
void setup() {
 ...
 setTime(18,12,0,2,5,16); // set time to 18:12 on 2 May 2016 (24hr clock)
 pinMode(led, OUTPUT);
...
// summer script: comes on when basement below lower offset and goes off when temp above upper offset  
 if (!isNightTime) 
{ 
   if ((basementTooCold) && (isSomeoneHome))
   {
     digitalWrite(Relay, HIGH);
   }
   else if (basementTooHot)
   {
